...
export default function DigitalMarketingPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Engage your audience and build brand presence across platforms",
    },
    {
    ...
    },
    {
      ...
      description:
        "Drive immediate traffic with targeted pay-per-click campaigns",
    },
    {
  ...
  const processSteps = [
    {
      ...
      description:
        "We analyze your goals and create a customized marketing plan",
    },
    {
      title: "Implementation",
      description: "Our team executes your marketing strategy across channels",
    },
    {
      title: "Optimization",
      description: "We continuously refine campaigns based on performance data",
    },
    {
      title: "Monitoring",
      description: "Regular tracking of key metrics and campaign performance",
    },
    {
      title: "Reporting",
      description: "Detailed insights and recommendations for improvement",
    },
    {
      title: "Scaling",
      description: "Expanding successful strategies to maximize ROI",
    },
  ];
  ...
  const portfolioItems: Record<string, any[]> = {
    ...
    social: [
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1616469829476-8953c5655574?auto=format&fit=crop&w=800&q=80",
        features: [
    ...
    content: [
      {
        ...
        description:
          "Developed holistic content plan driving 300% more traffic",
        image:
  ...
  return (
    <div className="min-h-screen bg-[#0B1C2D] text-white">
      {/* Hero Section */}
      <section className="relative bg-[#0B1C2D] py-16 md:py-20 overflow-hidden">
        <div className="absolute inset-0 bg-black/40"></div>
        <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2">
            <h1 className="text-5xl font-bold mb-6 leading-tight">
              Digital <span className="text-white"> Marketing</span><br />
              Services
            </h1>
            <p className="text-xl mb-8 opacity-90">
              Data-driven strategies that drive growth, engagement, and
...
"
      ...
      <section className="py-16 container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((s, i) => (
            <div
              key={i}
              className="bg-gray-800 p-8 rounded-2xl border border-gray-700 hover:border-white/30 transition"
            >
      ...
      {/* CTA */}
      <section className="py-16 bg-[#0B1C2D] relative">
        <div className="absolute inset-0 bg-black/40"></div>
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl max-w-3xl mx-auto mb-10 opacity-90">
            Let&apos;s discuss your digital marketing needs and create a
