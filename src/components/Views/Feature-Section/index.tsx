      ...
      <div className="wrapper flex justify-center gap-8">
        <div className="hidden lg:inline">
          <Image
            ...
            width={320} // Add width and height props
            height={400}
          />
        </div>
        <div className="z-10 relative">
          <div className="pl-0 pt-8 sm:pt-10 sm:pl-10 sm:space-y-2 space-y-5">
            <Image
              ...
              width={80} // Add width and height props
              height={80}
            />
          ...
          <div className="inline lg:hidden">
            <Image
              ...
              width={288} // Add width and height props
              height={360}
            />
          </div>

          <div className="sm:pt-10 sm:pl-10 max-w-3xl grid sm:grid-cols-2 grid-cols-1 gap-6">
            {/* Features components - these also need 'use client' if they use projectImages */}
            <Features
              ImageData={projectImages.FeatureImage1}
              Title="Business Growth"
              Description="Empowering businesses through innovative IT solutions, one byte at a time, as we surge ahead in our journey of exponential growth."
            />
